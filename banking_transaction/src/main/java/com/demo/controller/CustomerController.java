...
public class CustomerController {
    ...
    public String doUpdate(@PathVariable Long id, @ModelAttribute Customer customer, Model model) {
        ...
        if (!customerOptional.isPresent()) {
            model.addAttribute("error", true);
            model.addAttribute("messages", "customer does not exist");
        }
        else {
            customer.setId(id);
    ...
    public String doDeposit(@Valid @PathVariable Long customerId, @Validated @ModelAttribute Deposit deposit, BindingResult bindingResult, Model model) {
    ...
    public String doWithdraw(@Valid @PathVariable Long customerId, @Validated @ModelAttribute Withdraw withdraw, BindingResult bindingResult, Model model) {
        ...
        Customer customer1 = withdraw.getCustomer();
        BigDecimal currentBalance = customer1.getBalance();
